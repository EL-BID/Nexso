...
<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/media.min.js" />
<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/foundation.min.js" />
<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/nexso_i18n.js" Priority="90" />
<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/nexso.v2.min.js" Priority="95" />


<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/handlebars.js" />
<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/async.js" />

<%--<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/nexso.min.js" />--%>
<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/browse_solutions.js" />
<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/NEXSO_SOL_filters.js" />

<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/smooth-scroll.js" />
<dnn:DnnJsInclude runat="server" PathNameAlias="SkinPath" FilePath="scripts/scripts.js" />
      ...
      <div class="row">
        ...
        <div class="project-by">
          <ul class="clearfix">
            ...
            <li class="fomin"><a target="_blank" href="http://www.fomin.org"><img src="<%=SkinPath%><%=Localization.GetString("LogoMIF.Image",LocalResourceFile)%>" /></a></li>
          </ul>
