      ...
      F = {
          ...
          callback: function (a) {
              ...
              for (b = 0; b < e;) {
                  ...
                  d = "";
                  B ? (r && (n(a[b]), q && n(f[b])), q && (d += '<div class="user">' + v(f[b].innerHTML) + "</div>"), d += '<div class="tweetComplete"><p class="tweet">' + v(a[b].innerHTML) + "</p>", u && (d += '<p class="timePosted">' + g[b].getAttribute("aria-label").replace('Posted','') + "</p></div>")) : a[b].innerText ? (q && (d += '<p class="user">' + f[b].innerText + "</p>"), d += '<div class="tweetComplete"><p class="tweet">' + a[b].innerText + "</p>", u && (d += '<p class="timePosted">' + g[b].innerText.replace('Posted','') + "</p></div>")) : (q && (d += '<p class="user">' + f[b].textContent + "</p>"), d += '<p class="tweet">' + a[b].textContent +
                    "</p>", u && (d += '<p class="timePosted">' + g[b].textContent.replace('Posted','') + "</p></div>"));
