<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NZSolutionScoreMode.ascx.cs" Inherits="NZSolutionScoreMode" %>
    ...
    <div class="single-body">
        <div class="row">
            <div class="single-content">
                ...
                <div class="content-block">
                    <h2 class="sub-title">
                        <asp:Label ID="lblTagLineTitle" runat="server" resourcekey="TagLineTitle"></asp:Label></h2>
                    <h2 class="sub-title">
                        <asp:Label ID="lblTagLine" runat="server"></asp:Label></h2>
                    <asp:Label ID="lblTagLineScoreCardFlavor" CssClass="lblFlavor" runat="server"></asp:Label>
                ...
                <div class="content-block">
                    ...
                    <asp:Label ID="lblChallengeScoreCardFlavor" CssClass="lblFlavor" runat="server"></asp:Label>
                    <p>
                ...
                <div class="content-block">
                    ...
                    <asp:Label ID="lblApproachScoreCardFlavor" CssClass="lblFlavor" runat="server"></asp:Label>
                    <p>
                ...
                <div class="content-block">
                    ...
                    <asp:Label ID="lblResultsScoreCardFlavor" CssClass="lblFlavor" runat="server"></asp:Label>
                    <p>
                ...
                <div class="content-block">
                    ...
                    <asp:Label ID="lblImplementationDetailsScoreCardFlavor" CssClass="lblFlavor" runat="server"></asp:Label>
                ...
                <div id="dvOtherInformationPanelScore" runat="server">
                    <h4>
                        <asp:Label runat="server" resourcekey="Instructions"></asp:Label></h4>
                </div>
...
<div>
    <div class="row">
        ...
        <div>
            <div class="content-block">
                <h3 class="sub-title">
                    <asp:Label ID="lblTitleFeedback" runat="server" resourcekey="TitleFeedback"></asp:Label></h3>
                <div class="radiobuttonlist">
                    <asp:Label ID="lblFeedBackEs" runat="server" resourcekey="CommentEs"></asp:Label>
                    <asp:Label ID="lblFeedBackEn" Style="color: #a7a7a7;" CssClass="feedback" runat="server" resourcekey="CommentEn"></asp:Label>
                </div>
                <br />
                <asp:TextBox ID="txtFeedBack" TextMode="MultiLine" Columns="50" Rows="5" Style="height: 250px; margin-left: 10px;" placeholder="Comentario - Comment" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="validatorFeedBack" ControlToValidate="txtFeedBack" ValidationGroup="score"
                    resourcekey="rfvFeedBack" runat="server" />
            </div>
        </div>
        <div></div>
    </div>
...
<div runat="server" id="Comments" visible="false">
    <div class="discussion">
        ...
        <div id="box" class="box" runat="server">
