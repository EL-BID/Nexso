CREATE TABLE [dbo].[dnn_EasyDNNNewsChameleonNestedSettings] (
    ...
    [ResponsiveMainImageWidth]       INT            CONSTRAINT [DF_dnn_EasyDNNNewsChameleonNestedSettings_ResponsiveMainImageWidth] DEFAULT ((600)) NOT NULL,
    [GalleryLightbox]                TINYINT        CONSTRAINT [DF_dnn_EasyDNNNewsChameleonNestedSettings_GalleryLightbox] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_dnn_EasyDNNNewsChameleonNestedSettings] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_dnn_EasyDNNNewsChameleonNestedSettings_EasyDNNNews] FOREIGN KEY ([ArticleID]) REFERENCES [dbo].[dnn_EasyDNNNews] ([ArticleID]) ON DELETE CASCADE,
    CONSTRAINT [FK_dnn_EasyDNNNewsChameleonNestedSettings_Modules] FOREIGN KEY ([ModuleID]) REFERENCES [dbo].[dnn_Modules] ([ModuleID]) ON DELETE CASCADE,
    CONSTRAINT [FK_dnn_EasyDNNNewsChameleonNestedSettings_Portals] FOREIGN KEY ([PortalID]) REFERENCES [dbo].[dnn_Portals] ([PortalID]) ON DELETE CASCADE,
    CONSTRAINT [IX_dnn_EasyDNNNewsChameleonNestedSettings] UNIQUE NONCLUSTERED ([PortalID] ASC, [ModuleID] ASC, [ArticleID] ASC)
);
